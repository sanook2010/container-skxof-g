...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-skxof-g.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-skxof-g.containers.anotherwebservice.com/
...
```
git clone git@github.com:sanook2010/container-skxof-g.git
cd container-skxof-g
```
...
```
docker attach container-skxof-g
```
